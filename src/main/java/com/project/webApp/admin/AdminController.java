...
public class AdminController {
	...
	public String cafe_regist(Model model, HttpServletRequest req){
		//HttpSession session = req.getSession();
		//model.addAttribute("user_email",session.getAttribute("user_email"));
	...
	public ModelAndView cafe_view(@RequestParam("num") int num, HttpServletRequest req){
		//HttpSession session = req.getSession();
		AdminDAOInterface dao = sqlSession.getMapper(AdminDAOInterface.class);
		ModelAndView mav = new ModelAndView();
		//mav.addObject("user_email",session.getAttribute("user_email"));
	...
	public ModelAndView cafe_edit(@RequestParam("num") int num, HttpServletRequest req){
		//HttpSession session = req.getSession();
		AdminDAOInterface dao = sqlSession.getMapper(AdminDAOInterface.class);
		ModelAndView mav = new ModelAndView();
		//mav.addObject("user_email",session.getAttribute("user_email"));
	...
	public ModelAndView del(@RequestParam("num") int num, HttpServletRequest req){
		//HttpSession session = req.getSession();
		AdminDAOInterface dao = sqlSession.getMapper(AdminDAOInterface.class);
