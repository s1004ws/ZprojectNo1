...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
        ...
        var rules = {
          ...
          api: {
            ...
            '/v1/api/talk/memo/send': {
              method: 'post',
              data: {
                required: { template_id: _.passesOneOf([_.isNumber, _.isString]) }
              }
            },
            // Story
    ...
    }, { "../vendor/easyXDM.js": 13, "../vendor/es6-promise.js": 14, "./auth.js": 3, "./common.js": 6, "./util.js": 11 }], 3: [function (require, module, exports) {
      /*******************
       * Auth
       *******************/
      module.exports = function () {
          ...
          if (!_loginProxyWithTalk) {
            ...
            if (_k.UA.os.android) {
              ...
              (function () {
                ...
                // It is fallback proxy channel for login popup window opened by `S.browser_fallback_url`
        ...
        Auth.setRefreshToken = function (token, persist) {
          ...
          if (token !== null && persist === true) {
            // explicitly requested persistance
    ...
    }, { "../vendor/CryptoJS.js": 12, "../vendor/easyXDM.js": 13, "./auth.withTalk.js": 4, "./auth.withTalk.poller.js": 5, "./common.js": 6, "./util.js": 11 }], 4: [function (require, module, exports) {
      module.exports = function () {
        var _k = require('./common.js');

        var LOGIN_POPUP_NAME = '_blank'; // popup window name should be '_blank' for iOS Chrome. https://code.google.com/p/chromium/issues/detail?id=136610#c68
        var POPUP_FEATURES = 'width=380, height=520, scrollbars=yes';
        var isAndroidWebView = /Version\/4.0|/i.test(_k.UA.ua) && (/Chrome\/30\.0\.0\.0 Mobile/i.test(_k.UA.ua) || /; wv\)/i.test(_k.UA.ua));
        ...
        return {
          isSupport: function isSupport() {
            ...
            if (_k.UA.os.ios) {
              ...
              return _k.UA.browser.chrome && _k.UA.browser.version.major >= MIN_SUPPORT_VER_TO_APP_INTENT_FOR_ANDROID_CHROME && (!isAndroidWebView || isAndroidWebView && isSupportWebView);
            } else {
              return false;
            }
          },
          login: function login(stateToken, fallbackWebURL) {
            ...
            if (_k.UA.os.ios) {
              ...
              if (isSupportNativeFallbackURL() && !isAndroidWebView) {
    ...
    }, { "../vendor/userAgent.js": 15, "./util.js": 11 }], 7: [function (require, module, exports) {
      /*******************
       * Emoticon
       *******************/
      module.exports = function () {
      ...
      module.exports = function () {
        ...
        function buildLinkUrl(settings, callerMsg) {
          ...
          _.each(settings, function (setting, key) {
            ...
            if (linkObjectRule) {
              // if linkObjectRule exists, this is a link setting.
    ...
    }, { "../vendor/web2app.js": 16, "./common.js": 6, "./util.js": 11 }], 10: [function (require, module, exports) {
      module.exports = function () {
        var Story = {};
    ...
    }, { "../vendor/web2app.js": 16, "./common.js": 6, "./util.js": 11 }], 11: [function (require, module, exports) {
      /*
      ...
      module.exports = function () {
        ...
        _.getElement = function (selector) {
          if (_.isElement(selector)) {
            // passed in DOM element instead of selector
            return selector;
        ...
        _.localStorage = function () {
          ...
          try {
            ...
            // Win8/IE11 throws 'Access Denied'
            return shim;
          }
        }();
      ...
      // https://github.com/html5crew/web2app v1.0.12a
      module.exports = function () {
        ...
        var TIMEOUT_IOS = 2 * 1000,
            ...
            intentSupportCustomBrowserList = ['KAKAOTALK' // KAKAOTALK in app브라우져에서는 intent 를 지원한다.
        ];
